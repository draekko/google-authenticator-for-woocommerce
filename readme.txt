...
Adds a field for accepting a Google Authenticator token to WooCommerce's login form.

== Description ==
This plugin makes WooCommerce's login form compatible with the [Google Authenticator plugin](http://wordpress.org/plugins/google-authenticator/).
It adds a field for accepting a Google Authenticator token to WooCommerce's login form.
...
1. Upload *google-authenticator-for-woocommerce.zip* through the 'Plugins' menu in WordPress
2. Activate the plugin through the 'Plugins' menu in WordPress

or

1. Search for 'Google Authenticator for WooCommerece' in the 'Plugins' menu in WordPress.
